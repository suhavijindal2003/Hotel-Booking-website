...
const TripleRoom = () => (
  <div id='high-end' className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
    {/* Room Title */}
    <h1 className="text-4xl font-extrabold text-center text-gray-900 mb-12">Triple Room</h1>
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between">
        <div>
          ...
          <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            Luxurious French Provincial mansion, offering utmost comfort and elegance.
          </p>
          <ul className="space-y-4 text-gray-600 mb-6">
            <li className="flex items-start space-x-2">
              <span className="font-semibold">Price:</span>
              <span className="text-lg text-gray-800">$68 per night</span>
            </li>
            <li className="flex items-start space-x-2">
